...
'''
zidian = {"s":"2","c":'99','j':'50'}
#字典的访问
print(zidian['j'])
zidian['t'] = 80    #添加字典元素
print(zidian)
#字典的修改
zidian.update(c='100')  #使用update（）方法
print(zidian)
zidian['s'] = '5'
print(zidian)   #通过指定键修改元素
'''


#字典元素的删除
zidian02 = {'01':'张三','02':'李四','03':'小明','04':'小张'}
#用pop()方法删除指定键为01的元素
print(zidian02.pop('01'))
print(zidian02)
print(zidian02.popitem())   #使用popitem()方法随机删除元素
#用clear()方法清空字典的元素
zidian02.clear()
print(zidian02)